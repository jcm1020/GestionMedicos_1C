...
public class OracleSGBDErrorUtil implements SGBDErrorUtil {
	...
	// A�adir seg�n sea necesario, por parte del alumno...
	...
	public SGBDError translate(int errorSGBD) {
		switch (errorSGBD) {
		case FK_VIOLATED:
			// Se copia el texto �ntegro, como ejemplo, de la referencia dada
			// pero no se har� con el resto.
			/*
	...
	/**
	 * Comprueba si la excepci�n contiene un c�digo de error buscado.
	 * 
	 * @param ex
	 *            excepci�n con c�digo interno de la base de datos
	 * @param error
